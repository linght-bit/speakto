...
const RU = {
    ...
    win_message: {
      title: 'Поздравляем!',
      text: 'Миссия выполнена! Ты был(а) инкрушайм(а)! 🌟',
      button: 'Играть снова',
    },

    // Альтернативные решения при неправильной попытке
    suggestions: {
      pick_hay:       'Давай сначала возьмём сено!',
      throw_pick:     'Попробуй сначала бросить камень!',
      open_gate:      'Открой сначала ворота!',
      decor_pick:     'Укрась лошадку цветком!',
    },

    // Сообщения при неправильной попытке
    try_again: {
      fail_first:     'Не страшно, продолжай пробовать! 💪\nПовтори фразу медленнее.',
      fail_later:     'Ок, это пока не получается 😅',
    },

    // Контекстные подсказки для монстра
    context: {
      monster_has_axe:      '⚠️ Монстр! У тебя топор — атакуй!',
      monster_no_axe_away:  '⚠️ Монстр! Беги за топором — он снаружи!',
      monster_no_axe:       '⚠️ Монстр! Беги из загона!',
      exit_to_village:      'Отлично! Теперь иди к указателю справа 👉\nТам тебя ждёт деревня!',
    },
  };
...
const L2_RUS = {
  ...
  // Общие подсказки лисёнка
  fox_hints: {
    talk_to_npc: 'Поговори с Доной Марией!\nПодойди к ней.',
  },
